...
class PortfolioData {
  static const String name = 'Kuwar Vishnudatt';
  ...
  static const String email = 'kvd.kuwar@gmail.com';
  static const String githubUrl = 'https://github.com/Kuwar-Vishnudatt';
  static const String linkedinUrl =
      'https://www.linkedin.com/in/kuwar-vishnudatt-/';
  ...
  static const List<ProjectModel> projects = [
    ProjectModel(
      ...
      githubUrl: 'https://github.com/Kuwar-Vishnudatt/Hostel_help',
      ...
      screenshots: [
        'screenshots/hostel1.png',
        'screenshots/hostel2.png',
        'screenshots/hostel3.png',
        'screenshots/hostel4.png',
        'screenshots/hostel5.png',
        'screenshots/hostel6.png'
      ],
    ),
    ProjectModel(
      ...
      screenshots: [
        'screenshots/aviz1.png',
        'screenshots/aviz2.png',
        'screenshots/aviz3.png',
        'screenshots/aviz4.png',
        'screenshots/aviz5.png',
        'screenshots/aviz6.png'
      ],
    ),
    ProjectModel(
      ...
      githubUrl: 'https://github.com/Kuwar-Vishnudatt/catalog_app',
    ...
    ProjectModel(
      ...
      githubUrl: 'https://github.com/Kuwar-Vishnudatt/movie-app',
